...
public class RyanairScheduleService implements ScheduleService {
  ...
  public Flux<Flight> getDaysScheduledFlights(
    Airport departureAirport,
    Airport arrivalAirport,
    LocalDate localDate
  ) {
    if (departureAirport.equals(arrivalAirport)) return Flux.empty();
    ...
    Mono<Schedule> scheduleMono = ryanairSchedulesClient.getSchedule(
      parsedDepartureAirport,
      parsedArrivalAirport,
      parsedYear,
      parsedMonth
    );
